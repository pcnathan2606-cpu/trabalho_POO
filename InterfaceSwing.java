...
public class InterfaceSwing extends JFrame {
    ...
    // Novas variáveis para os níveis
    ...
    private void mostrarConfiguracao() {
        ...
        // Lado A
        JPanel pA = new JPanel(new GridLayout(5, 1)); // Aumentado para 5 linhas
        ...
        // Lado B
        JPanel pB = new JPanel(new GridLayout(5, 1)); // Aumentado para 5 linhas
    ...
    // Novo método para criar o controle de nível
    ...
    private void iniciarBatalha() {
        this.arena = new Arena(); // Resetar arena para nova luta
        
        // Agora utiliza as variáveis nvA e nvB
